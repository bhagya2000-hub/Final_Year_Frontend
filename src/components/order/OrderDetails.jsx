            ...
            <div className="row d-flex justify-content-center">
                <div className="col-12 col-lg-9 mt-5 order-details">
                    <div className="d-flex justify-content-between align-items-center">
                        ...
                        <Link className="btn btn-success" to={`/invoice/order/${id}`}>
                    ...
                    <table className="table table-striped table-bordered">
                        <tbody>
                            <tr>
                                <th scope="row">ID</th>
                                <td>{orderItems?.[0]?._id}</td> {/* Assuming orderItems is an array */}
                            </tr>
                            <tr>
                                <th scope="row">Status</th>
                                <td className={String(orderStatus).trim().toLowerCase().includes("delivered") ? "greenColor" : "redColor"}>
    <b>{orderStatus}</b>
</td>
                    ...
                    <table className="table table-striped table-bordered">
                        <tbody>
                            <tr>
                                <th scope="row">Status</th>
                                <td className={isPaid ? "greenColor" :"red"}>
